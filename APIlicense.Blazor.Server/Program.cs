    ...
    public static int Main(string[] args)
    {
        ...
        else
        {
            ...
            if (ContainsArgument(args, "updateDatabase"))
            {
                ...
                {
                    return serviceScope.ServiceProvider.GetRequiredService<DevExpress.ExpressApp.Utils.IDBUpdater>().Update(
                        ContainsArgument(args, "forceUpdate"),
                        ContainsArgument(args, "silent"));
                }
            }
            else
            {
